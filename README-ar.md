...
- **رفع الصور**: السماح للمستخدمين بإرفاق الصور مع رسائلهم
...
### 4. إعدادات رفع الصور
- **تمكين رفع الصور**: السماح للمستخدمين بإرفاق الصور
- **أقصى حجم للصورة**: تحديد الحد الأقصى لحجم الملف للتحميل
- **أقصى عدد للصور لكل رسالة**: تحديد عدد الصور لكل إرسال
- **أنواع الصور المسموح بها**: تحديد تنسيقات الصور المقبولة (مثل JPG, PNG, GIF)
...
- `enableImageUploads`: السماح بإرفاق الصور في البلوك

### إدارة الرسائل
1. انتقل إلى **الرسائل المجهولة > الرسائل**
2. عرض جميع الرسائل المرسلة ومرفقاتها
...
- `wp_anonymous_message_attachments`: بيانات مرفقات الصور
...
- **تحميل آمن للملفات**: التحقق من أنواع الملفات وأحجامها على الخادم

## 🌐 نقاط API

### نقاط AJAX
- `submit_anonymous_message`: التعامل مع إرسالات الرسائل (مع الصور)
...
### الإصدار 1.2.0
- تمت الإضافة: وظيفة تحميل الصور للرسائل
- تمت الإضافة: إعدادات المشرف لتحميل الصور (الحجم، النوع، العدد)
- تمت الإضافة: إشعارات البريد الإلكتروني للرسائل الجديدة
- تمت الإضافة: عداد الرسائل المعلقة في شريط الإدارة
- تحسين: تدويل كامل للإضافة
- إصلاح: شارة Recaptcha تظهر الآن فقط عند وجود البلوك

### الإصدار 1.1.1
- تصحيح: تكامل Recaptcha
...
### الإصدار 1.0.1
- تحسين ملف README
- إصلاح: مشكلة عرض إصدار الهاتف المحمول في ثيم بلوكسي

### الإصدار 1.0.0
- الإصدار الأولي
- وظائف الرسائل الأساسية
- تكامل بلوك Gutenberg
- نظام الإدارة
- تنفيذ ميزات الأمان
- دعم متعدد اللغات
