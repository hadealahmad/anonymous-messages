...
$wrapper_attributes = get_block_wrapper_attributes(array(
    'class' => 'anonymous-messages-block',
    'id' => $block_id,
    'data-show-categories' => $attributes['showCategories'] ? 'true' : 'false',
    'data-show-answered-questions' => $attributes['showAnsweredQuestions'] ? 'true' : 'false',
    'data-questions-per-page' => intval($attributes['questionsPerPage']),
    'data-enable-recaptcha' => $attributes['enableRecaptcha'] ? 'true' : 'false',
    'data-assigned-user-id' => intval($attributes['assignedUserId'] ?? 0),
    'data-enable-email-notifications' => isset($attributes['enableEmailNotifications']) && $attributes['enableEmailNotifications'] ? 'true' : 'false',
    'data-enable-image-uploads' => isset($attributes['enableImageUploads']) && $attributes['enableImageUploads'] && ($options['enable_image_uploads'] ?? true) ? 'true' : 'false',
    'style' => 'display: block !important; visibility: visible !important;'
));
?>

<?php if (!empty($content)) : ?>
    <!-- Anonymous Messages Block (InnerBlocks Layout) -->
...
<?php else : ?>
    <!-- Anonymous Messages Block (Monolithic Fallback) -->
    <div <?php echo $wrapper_attributes; ?>>
